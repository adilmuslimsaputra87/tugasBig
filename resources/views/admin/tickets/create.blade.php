...
<head>
    ...
    <title>Tambah Tiket - PrimeStage Admin</title>
    ...
    <div class="admin-page">
        ...
        <form class="form-container" method="POST" action="{{ route('tickets.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-input" placeholder="VVIP / VIP / Festival..." value="{{ old('name') }}" required>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="stock" class="form-input" placeholder="500" value="{{ old('stock') }}" min="1" required>
            ...
            <div class="form-group">
                ...
                <input type="text" name="description" class="form-input" placeholder="Deskripsi area tiket..." value="{{ old('description') }}">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="promo_valid_until" class="form-input" value="{{ old('promo_valid_until') }}">
            ...
            <div class="form-group">
                ...
                <input type="number" name="max_purchase" class="form-input" placeholder="4" value="{{ old('max_purchase', 4) }}" min="1" max="100" required>
